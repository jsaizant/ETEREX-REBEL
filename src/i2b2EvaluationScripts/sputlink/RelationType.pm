...
my $reversedTimemlRel = { 'BEFORE' => 'AFTER', 'IBEFORE' => 'IAFTER',
						  ...
						  'ENDS' => 'ENDED_BY', 'ENDED_BY' => 'ENDS', 'BEFORE_OVERLAP' => 'AFTER'};
...
my $tml2basic = { 'before' => '<', 'ibefore' => 'm', 'after' => '>', 'iafter' => 'mi',
		  ...
		  'begins' => 'm', 'begun_by' => 'mi', 'ends' => 'mi', 'ended_by' => 'm', 'before_overlap' => 'fi'};

my $basic2tml = { '<' => 'before', 'm' => 'ended_by','>' => 'after',
		  'di' => 'includes', 'd' => 'is_included',
		  '=' => 'simultaneous',
		  's' => 'begins', 'mi' => 'begun_by', 'fi' => 'before_overlap'};
