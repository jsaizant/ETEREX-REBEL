...
sub initialize 
{
    ...
    $self->{_ni_nj_ij_axioms}->{'o'}{'<'} = '<';
    $self->{_ni_nj_ij_axioms}->{'o'}{'m'} = '<';
    $self->{_ni_nj_ij_axioms}->{'o'}{'di'} = 'o';
    $self->{_ni_nj_ij_axioms}->{'o'}{'si'} = 'o';
    $self->{_ni_nj_ij_axioms}->{'o'}{'fi'} = 'o';
    $self->{_ni_nj_ij_axioms}->{'o'}{'o'} = '<';
    $self->{_ni_nj_ij_axioms}->{'<'}{'o'} = '<';
    $self->{_ni_nj_ij_axioms}->{'m'}{'o'} = '<';
    $self->{_ni_nj_ij_axioms}->{'di'}{'o'} = 'o';
    $self->{_ni_nj_ij_axioms}->{'si'}{'o'} = 'o';
    $self->{_ni_nj_ij_axioms}->{'fi'}{'o'} = 'o';
