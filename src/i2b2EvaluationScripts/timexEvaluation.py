...
if sys.version_info<(2,7):
    ...
    def timexEvaluation(gold_fname, system_fname, option,goldDic={},systemDic={}):
        ...
        import json, re
        docname = re.findall(r'\d+', system_fname)[0]
        jsontim = "/Users/josejaviersaizanton/Documents/TFM_local/data/error_eval/correcttimex/tim{}.json".format(docname)
        with open(jsontim, "w+") as outfile:
            json.dump(systemDic, outfile)
